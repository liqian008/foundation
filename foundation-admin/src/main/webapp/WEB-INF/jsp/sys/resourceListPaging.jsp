				...
				<div class="table-responsive">
					<table class="table table-bordered table-striped dataTable">
						...
						<tbody>
							...
							PagingResult<AdminResource> pagingResult = (PagingResult<AdminResource>)request.getAttribute("adminResourceList");
							List<AdminResource> adminResourceList = pagingResult.getPageData();

...
<div class="wrapper">
    ...
    <div class="content" id="container">
        ...
        <!-- Form begins -->
		<form:form id="form1" commandName="roleEntity" action="./saveRole" method="post" class="mainForm">
		       
        	<!-- Input text fields -->
            <fieldset>
					<div class="widget first">
						<div class="head">
							<h5 class="iList">编辑角色</h5>
						</div>
						<div class="rowElem noborder">
							<label>角色名称:</label>
							<div class="formRight">
								<form:hidden path="id" />
								<input name="roleName" type="text" value="${roleEntity.roleName }" maxlength="11"/>
							</div>
						</div>
						<div class="rowElem noborder">
							<label>当前状态:</label>
							<div class="formRight">
								<form:select path="status" class="styled"> 						

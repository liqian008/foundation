...
<div class="wrapper">
    ...
    <div class="content" id="container">
        ...
        <!-- Form begins -->
        <form:form id="form1" commandName="roleInfo" action="./saveRoleResource" method="post" class="mainForm">
			<!-- Input text fields -->
            <fieldset>
					<div class="widget first">
						<div class="head">
							<h5 class="iList">编辑角色资源</h5>
						</div>
						...
						<div class="rowElem noborder">
							<label>赋予的资源:</label>
							<div class="formRight">
								<form:checkboxes items="${allMenus}" path="menus" itemValue="id" itemLabel="menuName"  delimiter="&nbsp;"/>
							</div>
						</div>
